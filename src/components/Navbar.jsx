        ...
        <div className='flex items-center justify-between p-4 '>
            ...
            <div className="flex gap-4 items-center">
                ...
                <div className="text-[#AFAFAF] flex items-center gap-1">
                    ...
                    <span>Folder 2</span>
                    <img src={Arrow} alt="Arrow" className='w-3 h-3' />
                    <span className='text-[#121212] font-semibold'>Spreadsheet 3</span>
            ...
            <div className="flex items-center gap-1">
                <div className="bg-[#E2E2E2] flex items-center p-3 gap-2 rounded-md">
                    ...
                    <span className='text-[#757575] text-sm'>Search within sheet</span>
                </div>

                <div className="flex items-center gap-1">
                    <img src={Alert} alt="Alert" className='w-6 h-6' />
                    <img src={NotificationCount} alt="NotoficationCount" className='h-4 w-4 absolute right-34 top-6' />
                    <div className="flex items-center px-2 py-1.5 gap-2">
                        ...
                        <div className="flex flex-col space-y-[-6px] ">
                            ...
                            <span className='text-xs text-[#757575]'>john.doe...</span>
                        </div>
                    </div>
                </div>
